function openModal() {
	...
	myInput.onkeyup = function() {
       console.log('helllooo')//what is this doing ???????????
    ...
    confirmMyInput.onkeyup = function() {
                ...
                var passEqualsConfPass = ("psw" == "cpsw"); // TODO: Change this to the condition that needs to be checked so that the text entered in password equals the text in confirm password
...
function enableButton(letter, capital, number, length, match) {
    ...
    var condition = (myInput.value.match(lowerCaseLetters)&& myInput.value.match(upperCaseLetters)&& myInput.value.match(numbers)&& myInput.value.length >= minLengthvv && passEqualsConfPass); // TODO: Replace false with the correct condition
    if(condition) {
